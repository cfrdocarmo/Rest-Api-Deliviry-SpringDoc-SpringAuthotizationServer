...
public interface CidadeControllerOpenApi {
    ...
    public CidadeModel buscarPorId(@Parameter(description = "ID de uma cidade", example = "1", required = true) Long cidadeId);
    ...
    public CidadeModel atualizar(@Parameter(description = "ID de uma cidade", example = "1", required = true) Long cidadeId,
