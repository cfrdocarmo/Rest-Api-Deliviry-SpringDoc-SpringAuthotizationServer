...
import com.cfrdocarmo.cfrfood.api.v1.controller.EstatisticasController;
...
public interface EstatisticaControllerOpenApi {
    ...
    @Operation(
            ...
            parameters = {
                    ...
                    @Parameter(in = ParameterIn.QUERY, name = "dataCriacaoInicio", description = "Data/hora inicial da criação do pedido", example = "2019-10-30T00:00:00Z", schema = @Schema(type = "string", format = "date-time")),
                    @Parameter(in = ParameterIn.QUERY, name = "dataCriacaoFim", description = "Data/hora final da criação do pedido", example = "2019-11-04T23:59:59Z", schema = @Schema(type = "string", format = "date-time"))
            },
            responses = {
