...
public interface GrupoPermissaoControllerOpenApi {
    ...
    ResponseEntity<Void> removerPermissao(@Parameter(description = "ID de um grupo", example = "1", required = true) Long grupoId,
    ...
    ResponseEntity<Void> adicionarPermissao(@Parameter(description = "ID de um grupo", example = "1", required = true) Long grupoId,
                                            @Parameter(description = "ID de uma permissão", example = "1", required = true) Long permissaoId);
