...
public interface PedidoControllerOpenApi {
    ...
    @PageableParameter
    public PagedModel<PedidoResumoModel> pesquisar(@Parameter(hidden = true) PedidoFilter filtro,@Parameter(hidden = true) @PageableDefault(size = 10) Pageable pageable);
    ...
    @Operation(summary = "Cadastra um pedido", responses = {
            @ApiResponse(responseCode = "201", description = "Pedido resgistrado")
    })
    public PedidoModel adicionar(@RequestBody(description = "Representação de novo pedido", required = true) PedidoInput pedidoInput);
