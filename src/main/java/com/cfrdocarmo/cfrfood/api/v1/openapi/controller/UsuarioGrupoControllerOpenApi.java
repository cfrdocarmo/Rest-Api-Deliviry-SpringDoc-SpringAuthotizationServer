...
public interface UsuarioGrupoControllerOpenApi {
    ...
    public ResponseEntity<Void> adicionarGrupo(@Parameter(description = "ID do usuário", example = "1", required = true) Long usuarioId,
    ...
    public ResponseEntity<Void> removerGrupo(@Parameter(description = "ID do usuário", example = "1", required = true) Long usuarioId,
                                             @Parameter(description = "ID do grupo", example = "1", required = true) Long grupoId);
