...
public class AuthorizationServerConfig {
    ...
    @Bean
    public ProviderSettings providerSettings(CFRdoCarmoFoodSecutiryProperties properties) {
...
//        RegisteredClient cfrdocarmofoodBackend = RegisteredClient
//                .withId("1")
//                .clientId("cfrdocarmofoodBackend")
...
//                .build();
//
//        RegisteredClient cfrdocarmofoodWeb = RegisteredClient
//                .withId("2")
//                .clientId("cfrdocarmofood-web")
...
//                        .accessTokenTimeToLive(Duration.ofMinutes(30))
//                        .build())
//                .redirectUri("http://www.foodanalytics.local:5500/foodanalytics/")
...
//
//        repository.save(cfrdocarmofoodBackend);
//        repository.save(cfrdocarmofoodWeb);
