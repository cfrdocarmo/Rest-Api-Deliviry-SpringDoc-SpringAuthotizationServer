...
lock tables cidade write, cozinha write, estado write, forma_pagamento write, grupo write, grupo_permissao write, permissao write, produto write,
            ...
            pedido write, item_pedido write, foto_produto write, oauth2_registered_client write, oauth_code write, oauth2_authorization write;
...
--            'READ,WRITE', 'password,authorization_code', 'http://127.0.0.1:8080,http://localhost:8080/swagger-ui/oauth2-redirect.html,http://localhost:8080/authorized', null,
